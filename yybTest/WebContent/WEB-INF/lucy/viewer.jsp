<%@ page language="java" contentType="text/html; charset=gbk"
 import="java.io.File, java.util.Hashtable, java.util.Locale,java.net.URLEncoder"
 pageEncoding="GBK"%>
<%!
//文件名
...
private static final String HOME_PATH ="E:\\Program Files\\Apache Software Foundation\\Tomcat 6.0\\webapps";
//服务器是否是tomcat
